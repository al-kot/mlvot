...
def main():
    ...
    m_path = os.path.join(base, "reid_osnet_x025_market1501.onnx")
    o_txt = os.path.join(base, "tp4", "ADL-Rundle-6.txt")
    o_vid = os.path.join(base, "tp4", "ADL-Rundle-6.mp4")
    ...
    for i, fn in enumerate(tqdm(fns)):
        ...
        res = trk.update(dets.get(fid, []), im)
